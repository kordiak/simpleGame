...
-------------------------------------------------------------------------------
function prepareLogMsg(pattern, dt, level, where, line, message)

    local logMsg = pattern or "%date %project %level %where:%line %message"
    message = string.gsub(message, "%%", "%%%%")
    logMsg = string.gsub(logMsg, "%%date", dt)
    logMsg = string.gsub(logMsg, "%%where", where)
    logMsg = string.gsub(logMsg, "%%line", line)
    logMsg = string.gsub(logMsg, "%%project", "FP")
