...
local mainBoard = {}
local mainBoardGroup = display.newGroup()
mainBoard.mainBoardGroup = mainBoardGroup
--for i = 1, 70 do
mainBoard.new = function()
    ...
    local function mainBoardGenerator()
        for a = 1, properties.mainBoard2Rows / 2 do
            ...
            for i = 1, properties.mainBoard2HexesInRow do
            ...
            for i = 1, (properties.mainBoard2HexesInRow - 1) do
                local hex = display.newImageRect(properties.hexTexturePath, 88, 77)
    ...
    local function setText()
        for i = 1, #mainBoard do
            ...
            mainBoardGroup:insert(mainBoard[i].text)
        end
    end
